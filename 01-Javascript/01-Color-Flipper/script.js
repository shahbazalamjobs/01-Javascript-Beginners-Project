...
const containerColorCode = document.querySelector('.container__colorCode');
const containerButton = document.querySelector('.container__button');
const body = document.querySelector('body');

containerButton.addEventListener('click', () => {
    const randomColor = colors[Math.floor(Math.random() * length)];
    containerColorCode.textContent = randomColor;
